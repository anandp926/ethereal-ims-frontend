...
class Clock extends Component {
    ...
    render() {
      ...
      return (
        <div style={{border: '1px solid #001529'}}>
          ...
          <div className="digital">{new Date().toLocaleDateString(timeZone, options)}; {this.state.date.toLocaleTimeString(timeZone,{hour12: true})}</div>
        </div>     
      );
    }
  }
